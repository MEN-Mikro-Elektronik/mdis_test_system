...
function z135_hsuart_description {
    ...
    echo "    5.Check if both HSUART interfaces send and received data properly"
    echo "PURPOSE:"
    echo "    Check if men_lx_z135 driver is loaded correctly,"
    echo "    and it is possible to send/receive data on ttyHSU* device"
    echo "UPPER_REQUIREMENT_ID:"
    echo "    MEN_13MD0590_SWR_1310"
    #echo "REQUIREMENT_ID:"
