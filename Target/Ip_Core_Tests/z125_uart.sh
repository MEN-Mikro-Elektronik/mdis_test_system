...
function z125_uart_description {
    ...
    echo "    4.- If 2 UART interfaces are available on board perform echo test on"
    echo "        these devices"
    echo "      - If 1 UART interface is available on board perform echo test on"
    echo "        that device"
