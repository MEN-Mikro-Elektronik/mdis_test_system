...
echo ${1} | sudo -S --prompt= "${MyDir}/St_0002.sh" ${TestSummaryDirectory}
echo ${1} | sudo -S --prompt= "${MyDir}/St_0003.sh" ${TestSummaryDirectory}
echo ${1} | sudo -S --prompt= "${MyDir}/St_0007.sh" ${TestSummaryDirectory}
echo ${1} | sudo -S --prompt= "${MyDir}/St_0008.sh" ${TestSummaryDirectory}
echo ${1} | sudo -S --prompt= "${MyDir}/St_0009.sh" ${TestSummaryDirectory}
